...
def get_files(emotion):
    images = glob.glob("./KDEF/%s/*" %emotion)
...
def make_sets():
    ...
    for emotion in emotions:
        ...
        #add data to training and testing dataset, and generate labels 0-2
...
def create_model():
    ...
    print("Mean Accuracy Value: %.3f" %np.mean(accur_lin))   #Get mean accuracy
